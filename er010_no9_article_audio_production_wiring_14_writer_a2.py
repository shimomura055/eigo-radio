...
# Runs the official Production writer path for A2 only, against the
# canonical No.9 out_dir, with unbuffered stdout for live progress.
import time
...
t0 = time.time()
result = gen.run_one_pattern(client, n9.THEME_ID, "A2", prompt, verified_ledger_text,
