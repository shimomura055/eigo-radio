# ============================================================
# er003_v1_b1_p1_generate.py
# ER-003-B1-P1: A01 B1本文の実API生成(1回だけ、retryなし)
# ============================================================
# 実行方法:
#   .venv/Scripts/python.exe er003_v1_b1_p1_generate.py
...
OUT_DIR = "er003_output/b1_p1/A01"
...
def run(make_generator_factory=None) -> dict:
    ...
    en_sha256_after = b1.sha256_text(b1.load_natural_english_source())
    source_master_unchanged = en_sha256_before == en_sha256_after

    generation_metadata = {
        "experiment_version": b1.EXPERIMENT_VERSION,
        "topic_id": b1.TOPIC_ID,
