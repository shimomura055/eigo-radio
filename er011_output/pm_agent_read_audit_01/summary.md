...
総呼び出し件数(read系): 752
総委任(Task)件数: 281
総読込文字数(全ソース合算、Fable+Sonnet+Opus): 1,575,673 字 (概算 716,215 token)

## 管理ID別サマリ(上位、総読込文字数順)
- EDITORIAL-B-FAMILY-VOICES-3V-PRODUCTION-WIRING-PHASE1B-04-GENERALIZATION-AND-REGRESSION: 281,790 字
    - subagent:current_session_2026-09-11_12: 275,193 字 (133回呼び出し, full_read=22, partial=21, delegation_sent=0字)
    - fable:current_session_2026-09-11_12: 6,597 字 (12回呼び出し, full_read=1, partial=1, delegation_sent=14,495字)
    - 重複読込(同一ファイル再読込)文字数: 128,229 / うちAgent間重複: 32,086
...
- FAMILY-A-NEWS-LEDGER-CANONICAL-EN-SPELLING-TRIAL-15: 122,329 字
    - subagent:current_session_2026-09-11_12: 118,023 字 (65回呼び出し, full_read=1, partial=3, delegation_sent=0字)
    - fable:current_session_2026-09-11_12: 4,306 字 (6回呼び出し, full_read=0, partial=1, delegation_sent=6,948字)
    - 重複読込(同一ファイル再読込)文字数: 28,234 / うちAgent間重複: 0
- FAMILY-A-DISCOVERY-GENERALIZATION-TOWELS-TRIAL-11-STANDARD-PLAYER-01: 111,101 字
    - subagent:current_session_2026-09-11_12: 111,101 字 (37回呼び出し, full_read=4, partial=5, delegation_sent=0字)
    - fable:current_session_2026-09-11_12: 0 字 (1回呼び出し, full_read=0, partial=0, delegation_sent=1,897字)
    - 重複読込(同一ファイル再読込)文字数: 9,272 / うちAgent間重複: 0
...
- PM-REPORT-FULL-REPRESENTATION-DRAFT-2026-09-12-01: 11,920 字
    - fable:current_session_2026-09-11_12: 11,920 字 (8回呼び出し, full_read=0, partial=4, delegation_sent=3,974字)
    - 重複読込(同一ファイル再読込)文字数: 5,932 / うちAgent間重複: 0
...
- ER-009-JA-READING-DICTIONARY-ACRONYM-EXPANSION-AND-TREND-A2-RESUME-01: 4,887 字
    - fable:current_session_2026-09-11_12: 4,887 字 (3回呼び出し, full_read=0, partial=0, delegation_sent=5,446字)
    - 重複読込(同一ファイル再読込)文字数: 0 / うちAgent間重複: 0
...
- [EDITORIAL-B-FAMILY-VOICES-3V-PRODUCTION-WIRING-PHASE1B-04-GENERALIZATION-AND-REGRESSION] c:/users/tensh/eigo-radio/er012_b_family_voices_writer_generic_01.py — 17回読込, 重複60,899字(Agent間重複0字), sources=['subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
...
- [EDITORIAL-B-FAMILY-VOICES-3V-PRODUCTION-WIRING-PHASE1B-04-GENERALIZATION-AND-REGRESSION] c:/users/tensh/eigo-radio/editorial-b-family-voices-3v-production-wiring-phase1b-04_report.md — 9回読込, 重複24,816字(Agent間重複24,816字), sources=['fable:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
- [FAMILY-A-NEWS-LEDGER-CANONICAL-EN-SPELLING-TRIAL-15] er011_news_ledger_canonical_spelling_trial_15_run.py — 17回読込, 重複16,104字(Agent間重複0字), sources=['subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
...
- [EDITORIAL-B-FAMILY-VOICES-3V-PRODUCTION-WIRING-PHASE1B-04-GENERALIZATION-AND-REGRESSION] c:/users/tensh/eigo-radio/docs/pm/active_task_3v_1b04.md — 5回読込, 重複9,111字(Agent間重複0字), sources=['subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
...
- [EDITORIAL-B-FAMILY-VOICES-3V-PRODUCTION-WIRING-PHASE1B-04-GENERALIZATION-AND-REGRESSION] c:/users/tensh/eigo-radio/docs/pm/result_packet_3v_1b04.md — 4回読込, 重複7,270字(Agent間重複7,270字), sources=['fable:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
...
- [FAMILY-A-NEWS-LEDGER-CANONICAL-EN-SPELLING-TRIAL-15] er011_point_role_planning_focus_connection_trial_03.py — 3回読込, 重複6,105字(Agent間重複0字), sources=['subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
...
- [FAMILY-A-DISCOVERY-GENERALIZATION-TOWELS-TRIAL-11-STANDARD-PLAYER-01] c:/users/tensh/eigo-radio/docs/pm/pm_governance.md — 3回読込, 重複5,201字(Agent間重複0字), sources=['subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
...
- [EDITORIAL-B-FAMILY-VOICES-3V-PRODUCTION-WIRING-PHASE1B-04-GENERALIZATION-AND-REGRESSION] editorial-b-family-voices-3v-production-wiring-phase1b-04_report.md — 16回読込, 重複5,111字(Agent間重複0字), sources=['subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
...
- [EDITORIAL-B-FAMILY-VOICES-3V-PRODUCTION-WIRING-PHASE1B-04-GENERALIZATION-AND-REGRESSION] c:/users/tensh/appdata/local/temp/claude/c--users-tensh-eigo-radio/294958fe-da6e-491c-8a02-4f864d8195c8/tasks/bjc9ww38k.output — 2回読込, 重複4,008字(Agent間重複0字), sources=['subagent:current_session_2026-09-11_12', 'subagent:current_session_2026-09-11_12']
