...
Performance was lower when the phone stayed on the desk. Both attention and processing speed scores averaged about 100 with the phone on the desk, compared with about 109 when it was in another room.
...
Distraction is not always a visible choice. Someone can keep working and still spend more effort to stay with the task. The slower responses and larger brain signal were read as a sign of that extra control. So a person who never checks the screen may still pay an attention cost.
