...
- attempt files scanned: 421 (load errors: 0)
- usable records (segment_id あり): 421
- distinct segment groups: 320 (2+ attempts: 77)
...
|---|---|---|---|---|
| 1 | 1_immediate_lt5min | 34 | 23 | 0.6765 |
| 1 | 3_30min_to_6h | 1 | 1 | 1.0 |
| 2 | 1_immediate_lt5min | 9 | 2 | 0.2222 |
...
| パターン | 件数 |
|---|---|
| single_attempt_only | 243 |
| all_pass_no_retry_needed | 41 |
| ng_x1_then_pass_simple_retry | 25 |
| never_resolved_all_ng_in_log | 6 |
