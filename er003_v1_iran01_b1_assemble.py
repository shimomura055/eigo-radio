# ============================================================
# er003_v1_iran01_b1_assemble.py
# ER-003-IRAN-A2-B1-01: IRAN01 B1 Full Audio組み立て
# ============================================================
# VOICE-03時点で確立したShell構成・pause値・Voice Allocationを、
# er003_v1_sing01_assemble_v4_generate.pyからそのまま踏襲する。
# 新しい組み立てロジック・pause値は作らない。
#
# 実行方法:
#   .venv/Scripts/python.exe er003_v1_iran01_b1_assemble.py
...
def main():
    ...
    print("[IRAN01-B1-ASSEMBLE] 音源読み込み開始...")
    sources = load_all_sources()
    print("[IRAN01-B1-ASSEMBLE] gain調整開始...")
    parts = apply_gain_and_convert(sources)
    print("[IRAN01-B1-ASSEMBLE] assemble開始...")
    result = assemble_with_timeline(parts)
    assembled = result["assembled"]

    out_path = f"{OUT_DIR}/assembled/English_Your_Way_B1_IRAN01.wav"
    ...
    summary = {
        "status": "OK", "article_id": "IRAN01_B1", "out_path": out_path,
    ...
    print("[IRAN01-B1-ASSEMBLE] 完了。summary:", json.dumps(summary, ensure_ascii=False, default=str))
