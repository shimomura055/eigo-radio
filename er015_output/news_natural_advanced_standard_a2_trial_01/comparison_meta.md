# comparison_meta.md — Meta AI Call: Advanced(Natural English Baseline, 改変禁止) → Standard(B-1, A2)

Baseline source: `er015_output/news_ja_to_en_adaptation_trial_01/arms/arm3/output.md`
(sha256: 20b7ac01ffc962b55cdb9246425f54fa12e3d68f96a3328924d123dbefc3e481、
管理ID `NEWS-JA-TO-EN-ADAPTATION-TRIAL-01` arm3、ユーザー正式採用 `APPROVED_FOR_PRODUCTION`)
