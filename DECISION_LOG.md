...
- SSOT反映: `CURRENT_SPEC.md` L1262(新規行、TTS retry cool-down/Local Rewrite/Natural English QA仕様+Connected Speech 5 role適用範囲)。`OPEN_ITEMS.md` OPEN-122(適用範囲をA2/B1英語本文4segment限定から5 role[In One Line新規含む]へ更新、構造的欠落だった引数追加を明記、A2側Gapを記録)。
