# ============================================================
# er003_v1_repro02_b1_p1_generate.py
# ER-003-REPRO-02: ホルムズ海峡記事(ADD03) B1本文の初回プロトタイプ生成
# ============================================================
# er003_b1_article.py(A01専用、変更しない)の汎用関数をそのまま再利用し、
# パスの決定だけをこのスクリプト側でADD03向けに行う(ER-003-REPRO-01の
# A02向けスクリプトと同一パターン)。
#
# 実行方法:
#   .venv/Scripts/python.exe er003_v1_repro02_b1_p1_generate.py
...
def run(make_generator_factory=None) -> dict:
    ...
    generation_metadata = {
        "experiment_version": "ER-003-REPRO-02",
        "topic_id": TOPIC_ID,
