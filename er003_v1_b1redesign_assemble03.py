# ============================================================
# er003_v1_b1redesign_assemble03.py
# ER-003-POINT-NOTIFICATION-01: B1 Point専用Notification導入
# ============================================================
# AUDIO-02のtimelineから変更するのは、Point One/Two直前のNotification
# 音源のみ(共有Notificationから専用Point Notificationへ差し替え)。
# Comment 3文言・semantic heading・In One Line Voice・pause値・
# それ以外のsegmentはすべてAUDIO-02から無変更で再利用する。
#
# 実行方法:
#   .venv/Scripts/python.exe er003_v1_b1redesign_assemble03.py
...
def main():
    ...
    print("[B1-POINT-NOTIF] 音源読み込み開始...")
    sources = load_all_sources()
    print("[B1-POINT-NOTIF] gain調整開始...")
    parts = apply_gain_and_convert(sources)
    print("[B1-POINT-NOTIF] assemble開始...")
    result = assemble_with_timeline(parts)
    assembled = result["assembled"]

    out_path = f"{OUT_DIR}/assembled/English_Your_Way_B1B_IRAN01_v3.wav"
    ...
    summary = {
        "status": "OK", "article_id": "IRAN01_B1B_v3", "out_path": out_path,
    ...
    print("[B1-POINT-NOTIF] 完了。summary:", json.dumps(summary, ensure_ascii=False, default=str))
