# ============================================================
# er003_v1_b1redesign_assemble.py
# ER-003-B1-REDESIGN-AUDIO-01: B1-B Full Audio組み立て
# ============================================================
# 既存B1 Prototype Shell(VOICE-03のpause値・順序)を無変更で踏襲する。
# 新しい組み立てロジック・pause値は作らない。
#
# 実行方法:
#   .venv/Scripts/python.exe er003_v1_b1redesign_assemble.py
...
def main():
    ...
    print("[B1REDESIGN-ASSEMBLE] 音源読み込み開始...")
    sources = load_all_sources()
    print("[B1REDESIGN-ASSEMBLE] gain調整開始...")
    parts = apply_gain_and_convert(sources)
    print("[B1REDESIGN-ASSEMBLE] assemble開始...")
    result = assemble_with_timeline(parts)
    assembled = result["assembled"]

    out_path = f"{OUT_DIR}/assembled/English_Your_Way_B1B_IRAN01.wav"
    ...
    summary = {
        "status": "OK", "article_id": "IRAN01_B1B", "out_path": out_path,
    ...
    print("[B1REDESIGN-ASSEMBLE] 完了。summary:", json.dumps(summary, ensure_ascii=False, default=str))
