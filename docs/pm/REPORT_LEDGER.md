...
| EN-ASR-SEMANTIC-EQUIVALENCE-REVIEW-01 | 2026-09-26 | 済(2026-09-26 最終レビュー報告) | 済(2026-09-26: A-T回答済み、`EN-ASR-SEMANTIC-EQUIVALENCE-TRIAL-01`としてPhase A+B Trial実施) | N | read-only Recon+Fable批判レビュー22項目完了→Tier 2/3安全性補完レビュー完了、Status=REVIEW_COMPLETED(Trial deferred)。`EN-ASR-SEMANTIC-EQUIVALENCE-REVIEW-01_REPORT.md`Part 2追記、`OPEN_ITEMS.md` OPEN-186更新。推奨=段階導入Phase A/B/C、A-T回答済み(Trial実施)につき後続は`EN-ASR-SEMANTIC-EQUIVALENCE-TRIAL-01`行を参照。レビュー完了・A-T回答済みのため累積再掲対象から除外。 |
| NEWS-FAMILY-X-JA-FACT-DOUBLE-CHECK-COST-01 | 2026-09-26 | 済(2026-09-26) | 未 | Y | JA Original後/R2後ダブルチェックのコスト・latency実測(固定費中央値¥1.80/10記事¥18/30記事¥54/100記事¥180、詳細REPORT §6 Fable評価)。`OPEN_ITEMS.md` OPEN-187へ反映。ユーザーのJAダブルチェック正式採用判断待ち、Production変更なし。 |
| NEWS-FAMILY-X-SECTION-SEGMENTATION-TRIAL-01 | 2026-09-26 | 済(2026-09-26) | 未 | Y | Family X見出し境界(先取り検出+方式A移動)Trial、Fable評価VALIDATED(small_bag、詳細REPORT §10)。`OPEN_ITEMS.md`新規OPEN-188へ反映。ユーザー試読・採否判断待ち、Production Prompt未配線。 |
| EN-ASR-SEMANTIC-EQUIVALENCE-TRIAL-01 | 2026-09-26 | 済(2026-09-26) | 未 | Y | Phase A+B Trial実装(数値等価Tier1+複数形/固有名詞corroboration救済Tier3)、Fable評価VALIDATED(Phase A)/VALIDATED-offline(Phase B、詳細REPORT §9)。`OPEN_ITEMS.md` OPEN-186更新(Status=TRIAL_VALIDATED)。Production採用可否・配線範囲はユーザー判断待ち、Production module無変更。 |
