...
| Personalized News B1(新版初回、`USER-TEST-PERSONALIZED-NEWS-B1-REBUILD-01`再構築、`REPLACED_BY_FIX01`) | B1(B-Family、2V) | 完成(旧Ledgerを全面再Research[Part1政治的態度変化研究の現状+Part2機構/調査/規制の現状]し新Ledgerから新規生成。r8 attempt1でAnalytical Leakage Check 0件PASS[`leak_position_blur`含む全7項目]、Fact Checker verdict=PASS、Ledger Deviation=LEDGER_COMPLIANT、TTS/ASR14segment全OK、Human Review Lock発生なし) | Audio Validation Gate PASS(duration=321.175秒、peak=0.95049、clipping=False) | **ユーザー試聴Feedbackにより次行[FIX-01]で置き換え済み**(音声`audio/b1_2v/`は履歴として保持、無変更) | 旧URL: `https://rawcdn.githack.com/shimomura055/eigo-radio/e3cbed45229c7d7b386a05ef2750e067dbe4a0fd/user_test/unified.html?src=er012_output/personalized_news_b1_rebuild_01/audio/b1_2v/player.html&level=B1&en=One%20Feed%2C%20Two%20Very%20Different%20Experiences&ja=%E4%B8%80%E3%81%A4%E3%81%AE%E3%83%95%E3%82%A3%E3%83%BC%E3%83%89%E3%80%81%E4%BA%8C%E3%81%A4%E3%81%AE%E5%85%A8%E3%81%8F%E9%81%95%E3%81%86%E7%B5%8C%E9%A8%93`(E2E: `docs/pm/e2e_pn_b1_rebuild_01/e2e_result.json`、旧B1[`voices/audio/b1_2v_v2/`]は無変更のまま別行で保持) |
| Personalized News B1(FIX-01、`USER-TEST-PERSONALIZED-NEWS-B1-REBUILD-01-FIX-01`ユーザー試聴Feedback修正) | B1(B-Family、2V) | 完成(Hook「she has」→「he has」、Voice A heading「her personalized feed」→「his personalized feed」[Voice B「her feed is closing in」は無変更]、Voice A本文「I worry I may miss something important, but」削除。既存Validator[Analytical Leakage Check 2V・Ledger Deviation Checker]をWriter再生成なしでoffline再実行しany_flagged=False/LEDGER_COMPLIANT確認。Key Phrase初回KEY_WORDS_STRUCTURE_INVALID[finite verb混入]は既存前例と同一手当てでretry1回でPASS[新5件]。全14segment+Key Phrase音声[EN5+JA5]をProduction primitive経由で新規生成、Voice A=Algieba/Voice B=Erinome無変更、Human Review Lock発生なし) | Audio Validation Gate PASS(duration=321.155秒、peak=0.94082、clipping=False)。faster-whisper verbatim全14segment adjacent word repetition 0件。波形解析[click/pop・1.5秒超無音・音量変動係数]全件0件flagged(改訂後の平滑化ジャンプ方式、`audit_fix01/audio_qa.json`) | **PASS**(2026-09-18、`USER_TEST_READY`。ユーザー原文「視聴しました。問題ありません。承認します。」による正式承認[Trial評価ではない]、closeout`USER-TEST-PERSONALIZED-NEWS-B1-REBUILD-01-FIX-01-CLOSEOUT`。本行[FIX-01版]をPersonalized News Advancedのcanonical user-test artifactとして確定、旧版[初回版`audio/b1_2v/`・既存`voices/audio/b1_2v_v2/`]は非canonicalのまま維持。A2は無変更[sha256 diff一致、224ファイル]。Browser E2E 5項目全PASS+seek確認[60秒seek→currentTime=60.79秒]+表示script新文言のみ確認[旧文言0件]) | **正式URL(GitHub Pages、2026-09-18以降)**: `https://shimomura055.github.io/eigo-radio/user_test/unified.html?src=er012_output%2Fpersonalized_news_b1_rebuild_01%2Faudio%2Fb1_2v_fix01%2Fplayer.html&level=B1&en=One+Feed%2C+Two+Very+Different+Experiences&ja=%E4%B8%80%E3%81%A4%E3%81%AE%E3%83%95%E3%82%A3%E3%83%BC%E3%83%89%E3%80%81%E4%BA%8C%E3%81%A4%E3%81%AE%E5%85%A8%E3%81%8F%E9%81%95%E3%81%86%E7%B5%8C%E9%A8%93`(出典: `docs/user_test/ユーザーテスト記事一覧_2026-0918_選定10.tsv`)。旧経路(〜2026-09-18、SUPERSEDED): `https://rawcdn.githack.com/shimomura055/eigo-radio/7ea8bd7ac3f3cab60890057cac82a08b68ac619e/user_test/unified.html?src=er012_output/personalized_news_b1_rebuild_01/audio/b1_2v_fix01/player.html&level=B1&en=One%20Feed%2C%20Two%20Very%20Different%20Experiences&ja=%E4%B8%80%E3%81%A4%E3%81%AE%E3%83%95%E3%82%A3%E3%83%BC%E3%83%89%E3%80%81%E4%BA%8C%E3%81%A4%E3%81%AE%E5%85%A8%E3%81%8F%E9%81%95%E3%81%86%E7%B5%8C%E9%A8%93`(E2E: `docs/pm/e2e_pn_b1_rebuild_01_fix01/e2e_result.json`+`seek_and_text_check.json`、screenshot: `docs/pm/e2e_pn_b1_rebuild_01_fix01/screenshots/pn_b1_rebuild_fix01.png`) |
| Personalized News A2/B1 スクリプト理解しやすさ**Trial**(`USER-TEST-SCRIPT-READABILITY-TRIAL-01`、canonical行[上記2行]は無変更) | A2/B1 (Trial copy) | Trial copy `user_test/trial/script_readability_01/`(canonical player.html/parts.json/key_phrases参照のみ、mp3複製なし)にKey Phraseハイライト+日本語訳セクションを追加実装。canonicalのA2/B1ディレクトリ・`unified.html`・`articles_2026_0918.html`はsha256 before/after一致で無変更確認済み | 対象外(canonical音声・Gateは無変更、Trial copyのみ) | **TRIAL/`USER_DECISION_REQUIRED`**(技術結果は`VALIDATED`。Playwright E2E PASS[PC/スマホ×Standard/Advanced]、Key Phraseハイライト成功[Standard 4/5 exact+1 unmatched(活用形差)、Advanced 5/5 exact]、日本語訳section表示、既存Play機能への影響なし。ユーザーによるTrial実物確認・採否判断は未実施、10記事一覧・他9記事への展開は未実施) | Standard: `https://rawcdn.githack.com/shimomura055/eigo-radio/bf5c1e3b/user_test/trial/script_readability_01/unified_trial.html?src=er012_output%2Fb_family_a2_new_topic_production_01%2Fpersonalized_news_2v_a2%2Fplayer.html&level=A2&en=The+Same+Feed%2C+Two+Different+Mornings&ja=%E5%90%8C%E3%81%98%E3%83%95%E3%82%A3%E3%83%BC%E3%83%89%E3%80%81%E4%BA%8C%E3%81%A4%E3%81%AE%E9%81%95%E3%81%86%E6%9C%9D&trial=script_readability_01` / Advanced: `https://rawcdn.githack.com/shimomura055/eigo-radio/bf5c1e3b/user_test/trial/script_readability_01/unified_trial.html?src=er012_output%2Fpersonalized_news_b1_rebuild_01%2Faudio%2Fb1_2v_fix01%2Fplayer.html&level=B1&en=One+Feed%2C+Two+Very+Different+Experiences&ja=%E4%B8%80%E3%81%A4%E3%81%AE%E3%83%95%E3%82%A3%E3%83%BC%E3%83%89%E3%80%81%E4%BA%8C%E3%81%A4%E3%81%AE%E5%85%A8%E3%81%8F%E9%81%95%E3%81%86%E7%B5%8C%E9%A8%93&trial=script_readability_01`(E2E: `docs/pm/closeout_136_e2e/script_readability_trial_01/e2e_result.json`+screenshot4枚) |
| Tiny Bags(`USER-TEST-NEWS-LIGHT-TOPIC-01-CLOSEOUT-03`) | B1 | 完成(325.734秒、peak=0.73052、clippingなし。`point_one`は"only"5/6attempt脱落によりcanonical微修正[only→just]後1attempt目でNORMALIZED_MATCH。再生成なし・現行完成版のまま維持) | Audio Validation Gate PASS | **PASS**(2026-09-17、ユーザー本人が完成playerで通し試聴しOK/承認。`USER_TEST_READY`。**`USER-TEST-REVIEW-PAGE-FORMAT-RULE-01`で表示フォーマット修正反映[player.html/mp3無変更]、新SHA再発行、E2E PASS**) | **正式URL(GitHub Pages、2026-09-18以降)**: `https://shimomura055.github.io/eigo-radio/user_test/unified.html?src=er014_output%2Fuser_test_news_light_01%2Ftiny_bags%2Fb1b%2Fplayer.html&level=B1&en=Are+Tiny+Bags+Really+Back%3F+Fashion%27s+Answer+Comes+With+a+Catch&ja=%E5%B0%8F%E3%81%95%E3%81%84%E3%83%90%E3%83%83%E3%82%B0%E3%81%AF%E6%9C%AC%E5%BD%93%E3%81%AB%E6%B5%81%E8%A1%8C%E3%81%97%E3%81%A6%E3%81%84%E3%82%8B%E3%81%AE%E3%81%8B%E3%80%81%E3%83%95%E3%82%A1%E3%83%83%E3%82%B7%E3%83%A7%E3%83%B3%E3%81%AE%E7%AD%94%E3%81%88%E3%81%AF%E4%B8%80%E7%AD%8B%E7%B8%84%E3%81%A7%E3%81%AF%E3%81%84%E3%81%8B%E3%81%AA%E3%81%84`(出典: `docs/user_test/ユーザーテスト記事一覧_2026-0918_選定10.tsv`)。旧経路(〜2026-09-18、SUPERSEDED): `https://rawcdn.githack.com/shimomura055/eigo-radio/240e0723/user_test/unified.html?src=er014_output/user_test_news_light_01/tiny_bags/b1b/player.html&level=B1&en=Are%20Tiny%20Bags%20Really%20Back%3F%20Fashion%27s%20Answer%20Comes%20With%20a%20Catch&ja=%E5%B0%8F%E3%81%95%E3%81%84%E3%83%90%E3%83%83%E3%82%B0%E3%81%AF%E6%9C%AC%E5%BD%93%E3%81%AB%E6%B5%81%E8%A1%8C%E3%81%97%E3%81%A6%E3%81%84%E3%82%8B%E3%81%AE%E3%81%8B%E3%80%81%E3%83%95%E3%82%A1%E3%83%83%E3%82%B7%E3%83%A7%E3%83%B3%E3%81%AE%E7%AD%94%E3%81%88%E3%81%AF%E4%B8%80%E7%AD%8B%E7%B8%84%E3%81%A7%E3%81%AF%E3%81%84%E3%81%8B%E3%81%AA%E3%81%84`(旧evidence: `er014_output/user_test_news_light_01/tiny_bags/b1b/e2e/e2e_evidence.json`。新E2E: `docs/pm/closeout_136_e2e/format_rule_01/e2e_result.json`) |
| Tiny Bags(`USER-TEST-NEWS-LIGHT-TOPIC-01-CLOSEOUT-03`) | A2 | **完成**(`full_story_part2`のToteme/Kallmeyer、Human Review確認ページでの実読確認後ユーザー承認[TTS再生成なし]、`record_human_approval()`で正式記録。A2必須6% time-stretch post-processを承認済み音声へ追加適用[TTS新規生成なし、既存precedent[Trial-12/OPEN-112サブタスクG]と同型]。Assembly実行: 403.803秒、peak=0.95981、clippingなし) | Audio Validation Gate PASS(Human Approval記録によるHUMAN_APPROVED判定+slowdown post-process後にBLOCKED解消) | Human Review承認済み(ユーザーが確認ページでToteme/Kallmeyerの実読を確認し最終版として採用、2026-09-17。A2 playerは最終確認用。**`USER-TEST-REVIEW-PAGE-FORMAT-RULE-01`で表示フォーマット修正反映[player.html/mp3無変更]、新SHA再発行、E2E PASS**) | **正式URL(GitHub Pages、2026-09-18以降)**: `https://shimomura055.github.io/eigo-radio/user_test/unified.html?src=er014_output%2Fuser_test_news_light_01%2Ftiny_bags%2Fa2%2Fplayer.html&level=A2&en=Are+Tiny+Bags+Back%3F+Fashion%27s+Answer+Is+More+Complicated&ja=%E5%B0%8F%E3%81%95%E3%81%84%E3%83%90%E3%83%83%E3%82%B0%E3%81%AF%E6%9C%AC%E5%BD%93%E3%81%AB%E6%B5%81%E8%A1%8C%E3%81%97%E3%81%A6%E3%81%84%E3%82%8B%E3%81%AE%E3%81%8B%E3%80%81%E3%83%95%E3%82%A1%E3%83%83%E3%82%B7%E3%83%A7%E3%83%B3%E3%81%AE%E7%AD%94%E3%81%88%E3%81%AF%E4%B8%80%E7%AD%8B%E7%B8%84%E3%81%A7%E3%81%AF%E3%81%84%E3%81%8B%E3%81%AA%E3%81%84`(出典: `docs/user_test/ユーザーテスト記事一覧_2026-0918_選定10.tsv`)。旧経路(〜2026-09-18、SUPERSEDED): `https://rawcdn.githack.com/shimomura055/eigo-radio/240e0723/user_test/unified.html?src=er014_output/user_test_news_light_01/tiny_bags/a2/player.html&level=A2&en=Are%20Tiny%20Bags%20Back%3F%20Fashion%27s%20Answer%20Is%20More%20Complicated&ja=%E5%B0%8F%E3%81%95%E3%81%84%E3%83%90%E3%83%83%E3%82%B0%E3%81%AF%E6%9C%AC%E5%BD%93%E3%81%AB%E6%B5%81%E8%A1%8C%E3%81%97%E3%81%A6%E3%81%84%E3%82%8B%E3%81%AE%E3%81%8B%E3%80%81%E3%83%95%E3%82%A1%E3%83%83%E3%82%B7%E3%83%A7%E3%83%B3%E3%81%AE%E7%AD%94%E3%81%88%E3%81%AF%E4%B8%80%E7%AD%8B%E7%B8%84%E3%81%A7%E3%81%AF%E3%81%84%E3%81%8B%E3%81%AA%E3%81%84`(旧E2E evidence: `docs/pm/closeout_136_e2e/tiny_bags_a2_closeout03.json`+`.png`。新E2E: `docs/pm/closeout_136_e2e/format_rule_01/e2e_result.json`) |
| Convenience AI(`USER-TEST-NEWS-CONVENIENCE-AI-01-FINALIZE-A2`) | A2 | **完成**(`point_two`"Oimo no Canele"/"AI while"ともUSER APPROVED[2026-09-17、FIX-02確認ページのattempt9+6%slowdown候補]。`record_human_approval()`で正式承認記録[TTS新規生成なし、slowdown二重適用回避]、内蔵Primary ASR再検証[単発]は`ASR_VALIDATION_UNCERTAIN`のままだが追加Secondary ASR cascade[Ledger Phrase List使用]は`NORMALIZED_MATCH`/verified_content=True。Assembly実行: 323.279秒、peak=0.95344、clippingなし) | Audio Validation Gate PASS(Human Approval記録によるHUMAN_APPROVED判定) | **PASS**(2026-09-17、`USER_TEST_READY`。post-slowdown内蔵再検証の設計ギャップは`OPEN-168`で継続管理、記事完成はブロックしない。**`USER-TEST-REVIEW-PAGE-FORMAT-RULE-01`で表示フォーマット修正反映[player.html/mp3無変更、sha256記録済み]、新SHA再発行、E2E PASS**) | **正式URL(GitHub Pages、2026-09-18以降)**: `https://shimomura055.github.io/eigo-radio/user_test/unified.html?src=er014_output%2Fuser_test_news_convenience_ai_01%2Fconvenience_ai%2Fa2%2Fplayer.html&level=A2&en=Pickles+in+a+Lemon+Tart%3F+When+AI+Joins+the+Convenience-Store+Kitchen&ja=%E6%97%A5%E6%9C%AC%E3%81%AE%E3%82%B3%E3%83%B3%E3%83%93%E3%83%8B%E3%80%81AI%E3%81%A7%E6%96%B0%E3%81%97%E3%81%84%E5%91%B3%E3%82%92%E9%96%8B%E7%99%BA`(出典: `docs/user_test/ユーザーテスト記事一覧_2026-0918_選定10.tsv`)。旧経路(〜2026-09-18、SUPERSEDED): `https://rawcdn.githack.com/shimomura055/eigo-radio/240e0723/user_test/unified.html?src=er014_output/user_test_news_convenience_ai_01/convenience_ai/a2/player.html&level=A2&en=Pickles%20in%20a%20Lemon%20Tart%3F%20When%20AI%20Joins%20the%20Convenience-Store%20Kitchen&ja=%E6%97%A5%E6%9C%AC%E3%81%AE%E3%82%B3%E3%83%B3%E3%83%93%E3%83%8B%E3%80%81AI%E3%81%A7%E6%96%B0%E3%81%97%E3%81%84%E5%91%B3%E3%82%92%E9%96%8B%E7%99%BA`(旧E2E evidence: `docs/pm/closeout_136_e2e/convenience_ai_a2_finalize.json`+`.png`。新E2E: `docs/pm/closeout_136_e2e/format_rule_01/e2e_result.json`) |
| Convenience AI(`USER-TEST-NEWS-CONVENIENCE-AI-01-USER-REVIEW-FIX-02`) | B1 | **完成・ユーザー品質承認済み**(287.774秒、peak=0.95、clippingなし。`full_story_part1`のscript表示をユーザー実聴音声[実audio/ASR/独立local verbatim全て"Then Lawson planned..."]に合わせて語順修正[内容・事実は無変更、TTS再生成なし]、player再build) | Audio Validation Gate PASS | **PASS**(2026-09-17、`USER_TEST_READY`。記事全体ユーザーOK/承認済み。語順修正後は再試聴要求不要、`USER-TEST-NEWS-CONVENIENCE-AI-01-FINALIZE-A2`でscript/audio整合を再確認のみ[再build不要]。**`USER-TEST-REVIEW-PAGE-FORMAT-RULE-01`で表示フォーマット修正反映[player.html/mp3無変更]、新SHA再発行、E2E PASS**) | **正式URL(GitHub Pages、2026-09-18以降)**: `https://shimomura055.github.io/eigo-radio/user_test/unified.html?src=er014_output%2Fuser_test_news_convenience_ai_01%2Fconvenience_ai%2Fb1b%2Fplayer.html&level=B1&en=A+Lemon+Tart%2C+Pickles%2C+and+an+AI+Suggestion&ja=%E6%97%A5%E6%9C%AC%E3%81%AE%E3%82%B3%E3%83%B3%E3%83%93%E3%83%8B%E3%80%81AI%E3%81%A7%E6%96%B0%E3%81%97%E3%81%84%E5%91%B3%E3%82%92%E9%96%8B%E7%99%BA`(出典: `docs/user_test/ユーザーテスト記事一覧_2026-0918_選定10.tsv`)。旧経路(〜2026-09-18、SUPERSEDED): `https://rawcdn.githack.com/shimomura055/eigo-radio/240e0723/user_test/unified.html?src=er014_output/user_test_news_convenience_ai_01/convenience_ai/b1b/player.html&level=B1&en=A%20Lemon%20Tart%2C%20Pickles%2C%20and%20an%20AI%20Suggestion&ja=%E6%97%A5%E6%9C%AC%E3%81%AE%E3%82%B3%E3%83%B3%E3%83%93%E3%83%8B%E3%80%81AI%E3%81%A7%E6%96%B0%E3%81%97%E3%81%84%E5%91%B3%E3%82%92%E9%96%8B%E7%99%BA`(旧evidence: `.../b1b/human_review/e2e_evidence_fix02.json`。新E2E: `docs/pm/closeout_136_e2e/format_rule_01/e2e_result.json`) |
...
| ユーザーテスト一覧ページ(10記事、2026-09-18、`USER-TEST-ARTICLE-LANDING-10-01`、FIX-01でCSS修正済み、Phase EでGitHub Pages URLへ移行) | N/A(10記事へのリンク集約ページ) | 既存10記事(音声・player)への正式導線ページ本体を新規作成 | 全20リンクSSOT完全一致(Pages版`href_match_pages.json` PASS)+GitHub Pages公開runtime E2E(PC/mobile、`landing_e2e_pages.json`)PASS、代表4クリック遷移+Play確認PASS | **PRODUCTION_WIRED**(2026-09-18、`USER-TEST-SCRIPT-READABILITY-PROD-01`/`USER-TEST-HOSTING-GITHUB-PAGES-01` Phase EでGitHub Pagesへ正式移行。SSOT=`docs/user_test/ユーザーテスト記事一覧_2026-0918_選定10.tsv`をユーザー確定。リンク先10記事は個別に`USER_TEST_READY`/`user_quality_status`を保持、本行はそれらへの一覧導線ページ自体の状態) | ページ: `user_test/articles_2026_0918.html`、**正式公開URL(stable、今後メール・LINEで共有)**: `https://shimomura055.github.io/eigo-radio/user_test/articles_2026_0918.html`(evidence: `docs/pm/closeout_136_e2e/script_readability_prod_01/phase_e/`配下href_match_pages.json/landing_e2e_pages.json)。旧URL(SUPERSEDED、rawcdn.githack.com固定SHA、正式経路として使用しない): `https://rawcdn.githack.com/shimomura055/eigo-radio/41594eecc7d5e5dc07b506e52d38f895c473eb0e/user_test/articles_2026_0918.html`(evidence: `docs/pm/closeout_136_e2e/landing_10_01/`配下href_match_fix01.json/e2e_result_fix01.json/pc_full_fix01.png/mobile_full_fix01.png。初版evidenceはhref_match.json/http200_check.json/e2e_result.json/pc_full.png/mobile_full.png) |
| GitHub Pages root(ユーザーテストWeb Hosting、2026-09-18新規、`USER-TEST-HOSTING-GITHUB-PAGES-01`) | N/A(hosting infrastructure) | `.nojekyll`追加(Jekyll処理無効化)、リポジトリ`main`ブランチ・root配信をユーザーテスト正式配信経路として採用(GitHub Pages有効化自体はユーザーがGitHub Web UIで実施、実施時期はSSOT未記録[Precheckで実態確認]) | 20 level全件公開runtime E2E PASS(`e2e_result_pages20.json`)、rawgit警告回避確認PASS(`pages_warning_check.json`、新規browser context・githack/rawgitホスト0件)、Dangling Reference Check 9/9 PASS(`dangling_reference_check_pages.json`)、canonical sha256差分1件のみ(Landing href置換、`sha256_after_phase_e.json` vs Phase C比較) | **PRODUCTION_WIRED**(2026-09-18、push→deploy実測約83秒、`Cache-Control: max-age=600`) | root: `https://shimomura055.github.io/eigo-radio/`、個別記事URLパターン: `https://shimomura055.github.io/eigo-radio/user_test/unified.html?src=<src>&level=<lvl>&en=<en>&ja=<ja>`(固定SHA不要、常に最新main)。evidence: `docs/pm/closeout_136_e2e/script_readability_prod_01/phase_e/`一式、`docs/pm/RESULT_PACKET_SCRIPT_READABILITY_PROD_01_pages_precheck.md` |

## USER-TEST-14-ARTICLE-FORMAT-RECHECK-01(2026-09-17、Gate 7(n)表示フォーマット14記事再確認)

ユーザー管理Sheet「ユーザーテスト記事一覧_2026-09-16」掲載の14記事について、
`unified.html`(SHA`240e0723`)経由の表示フォーマット(Standard/Advanced表示・
Key Phrase英日2列・ラベル非表示・Play進行・script/KP/Comment表示)を
`docs/pm/tools/user_test_page_e2e_check.py`で26ページ(A2/B1合算)全件検証。
上記News-family 4記事(Space Weapons/Personalized News A2/Tiny Bags/
Convenience AI、8ページ、SHA更新済み)に加え、Family A(Smartphone/Young
Travelers/Towels/Wake Before Alarm/Refrigerator crisper)・Voices 2V
(Free-address)・Voices 3V(AI hiring、B1のみ)・Family C(Home Robots/
Memory/Digital Twins)の10記事18ページも同一チェッカーでPASS(26/26)。
これらFamily A/C・Voicesの独自テンプレート(`table.timeline`形式の監査用
player.html)は**無修正のまま**`unified.html`の汎用パーサ経由で適合済みと
確認(Gate 7(n)は`unified.html`側で吸収される設計のため、対象player.html
自体の修正は不要だった)。検証中に`unified.html`側の表示バグ1件を発見・
修正(AI hiring B1のKey Phrase 4で`<br>`区切りがtextContentで消え、
正規表現の誤マッチにより`JA(表示):`ラベル断片が英語列へ混入。`rowData()`を
`<br>`を実改行に変換してから解析するよう修正、commit`240e0723`)。
音声・記事本文・segment sha256は無変更(diff範囲は`unified.html`7行のみ)。
Personalized News B1は対象外(OPEN-166、旧B1非掲載)。AI hiring A2・
Personalized News B1は生成経路が存在しないため「—」。詳細な14記事対応表・
