...
| ユーザーテスト一覧ページ(10記事、2026-09-18、`USER-TEST-ARTICLE-LANDING-10-01`、FIX-01でCSS修正済み) | N/A(10記事へのリンク集約ページ) | 既存10記事(音声・player)への正式導線ページ本体を新規作成 | 全20リンクSSOT完全一致(`href_match_fix01.json` PASS)+全20 URL HTTP 200(`http200_check.json`)+Browser E2E PC/スマホ両方PASS、ボタン内テキスト1行判定含む(`e2e_result_fix01.json`) | **PRODUCTION_WIRED**(2026-09-18初版、FIX-01でCSS調整。SSOT=`docs/user_test/ユーザーテスト記事一覧_2026-0918_選定10.tsv`をユーザー確定。リンク先10記事は個別に`USER_TEST_READY`/`user_quality_status`を保持、本行はそれらへの一覧導線ページ自体の状態) | ページ: `user_test/articles_2026_0918.html`、公開URL(FIX-01固定): `https://rawcdn.githack.com/shimomura055/eigo-radio/41594eecc7d5e5dc07b506e52d38f895c473eb0e/user_test/articles_2026_0918.html`(evidence: `docs/pm/closeout_136_e2e/landing_10_01/`配下href_match_fix01.json/e2e_result_fix01.json/pc_full_fix01.png/mobile_full_fix01.png。初版evidenceはhref_match.json/http200_check.json/e2e_result.json/pc_full.png/mobile_full.png) |
