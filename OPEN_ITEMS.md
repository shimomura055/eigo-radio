...
| OPEN-13 | ER-003-A2-STRUCT-01 Candidate A: Full Storyブロック分割+日本語signpost挿入 | `PROTOTYPE_BUILT / UNDER_EVALUATION`(ER-003-A2-STRUCT-02でA02のプロトタイプを作成、ユーザー評価待ち) | 構造支援候補 | Non-blocking | ユーザーがA02プロトタイプ([ER-003-A2-STRUCT-02_A02_PROTOTYPE.md](ER-003-A2-STRUCT-02_A02_PROTOTYPE.md))を確認し、ADOPTED/REJECTEDを判断する |
