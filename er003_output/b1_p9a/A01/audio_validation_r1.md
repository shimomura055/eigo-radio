...
| sha256 | `83ed9c7ed6e2abd3d87085bbebf0aed4976eab13af61406adab85af8c606f10e` |
| duration | 258.362秒(約4分18秒) |
| sample rate | 48000Hz |
| channels | 2(stereo) |
| peak | 0.888 |
| clipping | 検出なし |
...
- プロジェクト全体回帰テスト(`run_project_regression.py`、
  er0*_test_*.py全探索): **1618件全合格、回帰なし**
...
- [English_Your_Way_A01_r1.wav](assembled/English_Your_Way_A01_r1.wav)(修正版、約4分18秒)
